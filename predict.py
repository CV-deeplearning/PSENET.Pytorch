...
if __name__ == '__main__':
    ...
    model_path = '/home/gp/work/project/PSENet.pytorch.mobilenetv3-small/output/psenet_jizhuangxiang_MobileNetV3_Small_1gpu_author_crop_adam_MultiStepLR_authorloss/PSENet_10_loss0.283093.pth'
    ...
    img_path = '/home/gp/work/project/PSENet.pytorch/data/jizhuangxiang/train/img/3.jpg'
    label_path = '/home/gp/work/project/PSENet.pytorch/data/jizhuangxiang/train/gt/gt_3.txt'
    label = _get_annotation(label_path)

    # 初始化网络
    net = PSENet(backbone='MobileNetV3_Small', pretrained=False, result_num=config.n)
